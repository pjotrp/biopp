%define name bpp-utils
%define version 1.3.1
%define release 1
%define _prefix /usr/local

Summary: The Bio++ Utils library.
Name: %{name}
Version: %{version}
Release: %{release}
...
%description
This library contains utilitary and core classes for Bio++.
...
- Version 1.3.1
* Fri Jul 21 2008 Julien Dutheil <jdutheil@daimi.au.dk>
- Version 1.3.0
